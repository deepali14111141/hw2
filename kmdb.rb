...
joseph_gordon = Person.new(values)
joseph_gordon.save
...
commissioner_gordon = Role.new(values)
...
values = { movie_id: dark_knight_rises.id, person_id: joseph_gordon.id, character_name: "John Blake"}
john_blake = Role.new(values)
john_blake.save
